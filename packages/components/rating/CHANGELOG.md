...
- [#563](https://github.com/hirotomoyamada/yamada-ui/pull/563) [`6472f46`](https://github.com/hirotomoyamada/yamada-ui/commit/6472f46795b321594ac26a348d81334d974d0629) Thanks [@hirotomoyamada](https://github.com/hirotomoyamada)! - Fixed a bug where `motion` animation was enabled when `readOnly` and `disabled`.
